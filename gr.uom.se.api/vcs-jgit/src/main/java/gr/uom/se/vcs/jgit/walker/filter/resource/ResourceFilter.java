...
import gr.uom.se.vcs.walker.filter.resource.ModifiedFilter;
import gr.uom.se.vcs.walker.filter.resource.PathFilter;
import gr.uom.se.vcs.walker.filter.resource.PathPrefixFilter;
import gr.uom.se.vcs.walker.filter.resource.SuffixFilter;
import gr.uom.se.vcs.walker.filter.resource.VCSResourceAndFilter;
import gr.uom.se.vcs.walker.filter.resource.VCSResourceFilter;
import gr.uom.se.vcs.walker.filter.resource.VCSResourceNotFilter;
import gr.uom.se.vcs.walker.filter.resource.VCSResourceOrFilter;
...
/**
 * A utility class to deal with JGit tree filters.
 * <p>
 * 
 * @author Elvis Ligu
 * @version 0.0.1
...
public class ResourceFilter {
   ...
   /**
    * Given a collection of filters creates a new filter that apply an AND
    * operator to them.
    * <p>
    * 
    * @param filters
   ...
   /**
    * Given a filter creates a new one that negates its result.
    * <p>
    * 
    * @param filter
    * @return
    */
   public static OptimizedResourceFilter<VCSResource> not(
         OptimizedResourceFilter<?> filter) {
      return new OptimizedResourceFilter<VCSResource>(filter.getCurrent()
            .negate());
   }

   /**
    * Given a collection of filters creates a new filter that apply an OR
    * operator to them.
    * <p>
    * 
    * @param filters
   ...
   /**
    * Given a collection of string paths, creates a new path prefix filter.
    * <p>
    * 
    * @param patterns
    *           of the paths
   ...
   /**
    * Will throw an {@link IllegalArgumentException} if the collection contains
   ...
   /**
    * Given a collection of string patterns, creates a new tree filter that
    * check for suffixes.
    * <p>
    * 
    * @param patterns
    ...
    */
   public static OptimizedResourceFilter<VCSResource> suffix(
         Collection<String> patterns) {
   ...
   /**
    * Creates a path filter that will allow only the specified paths.
    * <p>
    * 
    * @param paths
    *           to filter
    ...
    */
   public static OptimizedResourceFilter<VCSResource> path(
    ...
    * 
    * @param paths
    *           the parents of entries to be included
    * @return new child filter
    */
   public static OptimizedResourceFilter<VCSResource> child(
         Collection<String> paths) {
      return new OptimizedResourceFilter<VCSResource>(
            new JGitChildFilter(paths));
   }

   /**
    * Will parse a {@link VCSResourceFilter} and try to convert it to a JGit
    * tree filter.
    * <p>
    * 
    * @param filter
    *           to parse
    * @param parser
    *           if there is another parser available will check it first, if he
    *           can parse the filter it will be returned otherwise will try the
    *           default method.
    * @return
    */
   public static OptimizedResourceFilter<VCSResource> parse(
      ...
      if (gr.uom.se.vcs.walker.filter.resource.PathFilter.class
   ...
   /**
    * Will return a new path filter to be used within JGit library based on the
    * given filter.
    * <p>
    * 
    * @param filter
    *           to parse
    * @return a new {@link TreeFilter} implementation that corresponds to the
    *         given {@link PathFilter}
    */
   public static OptimizedResourceFilter<VCSResource> parsePath(
         gr.uom.se.vcs.walker.filter.resource.PathFilter<VCSResource> filter) {
      return path(filter.getPaths());
   }

   /**
    * Will return a new child filter to be used within JGit library based on the
    * given filter.
    * <p>
    * 
    * @param filter
   ...
   /**
    * Will return a new prefix filter to be used within JGit library based on
    * the given filter.
    * <p>
    * 
    * @param filter
   ...
   /**
    * Will return a new suffix filter to be used within JGit library based on
    * the given filter.
    * <p>
    * 
    * @param filter
    *           to parse
    * @return a new {@link TreeFilter} implementation that corresponds to the
    *         given {@link SuffixFilter}
    */
   public static OptimizedResourceFilter<VCSResource> parseSuffix(
         SuffixFilter<?> filter) {
      return suffix(filter.getSuffixes());
   }

   /**
    * Will return a new AND filter to be used within JGit library based on the
    * given filter.
    * <p>
    * 
    * @param filter
    *           to parse
    * @return a new {@link TreeFilter} implementation that corresponds to the
    *         given {@link VCSResourceAndFilter}
    */
   ...
   /**
    * Will return a new OR filter to be used within JGit library based on the
    * given filter.
    * <p>
    * 
    * @param filter
    *           to parse
    * @return a new {@link TreeFilter} implementation that corresponds to the
    *         given {@link VCSResourceOrFilter}
    */
   ...
   /**
    * Will return a new NOT filter to be used within JGit library based on the
    * given filter.
    * <p>
    * 
    * @param filter
    *           to parse
    * @return a new {@link TreeFilter} implementation that corresponds to the
    *         given {@link VCSResourceNotFilter}
    */
   ...
   /**
    * Will return a new ANY_DIFF filter to be used within JGit library based on
    * the given filter.
    * <p>
    * 
    * @param filter
    *           to parse
    * @return a new {@link TreeFilter} implementation that corresponds to the
    *         given {@link ModifiedFilter}
    */
   public static OptimizedResourceFilter<VCSResource> parseModified(
         ModifiedFilter<VCSResource> filter) {
      return modification();
   }
}

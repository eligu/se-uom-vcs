...
/**
 *  A special case of {@link ChildFilter} optimized for JGit library.<p>
 * 
 * @author Elvis Ligu
 * @version 0.0.1
 * @since 0.0.1
...
public class JGitChildFilter extends JGitAbstractPathFilter {
    ...
    /**
     * Check if the given path is a child of prefix.<p>
     * 
     * @param prefix the parent of path
     * @param path the child of prefix

...
/**
 * Test mock for class {@link VCSRepositoryImp}.
 * <p>
 * 
 * This class represents a repository mock that is stored at
 * {@link #REMOTE_GIT_SMALL}. The repository will be first cloned at
 * {@link #LOCAL_GIT_SMALL} if it is not already there and will load from there.
 * <p>
 * 
 * NOTE: the {@link #REMOTE_GIT_SMALL} is a local repository to because it is
 * stored in a local path within project's test resources, however we refer to
 * it as the remote because we want to check the cloning capabilities of
 * {@link VCSRepository}.
 * <p>
 * 
 * @author Elvis Ligu
...
public class RepoMock {
   ...
   public RepoMock() throws VCSRepositoryException {
      ...
      // Look at
      // http://permalink.gmane.org/gmane.comp.version-control.git/101989

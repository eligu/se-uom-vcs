...
/**
 * Test mock for class {@link VCSResourceImp}.
 * <p>
 * 
 * Each resource mock contains the path of resource, a list of commits that
 * create the resource, a list of commits that delete the resource, a list of
 * commits that modify the resource, and a list of commits where this resource
 * is available.
 * <p>
 * {@link #RESOURCES} array contains all the resources that may have been or are
 * already present in repository. And {@link #DIRS} contains a list of
 * directories.
 * 
 * @author Elvis Ligu
 * 
...
public class ResourceMock {
   ...
   /**
    * Resources of small repository, and their history.
    * <p>
    */
   public static final ResourceMock[] RESOURCES = new ResourceMock[] {
         new ResourceMock("src/Test.txt", new int[] { len - 1 },
               new int[] { len - 8 }, new int[0], new int[] { len - 1, len - 2,
                     len - 3, len - 4, len - 5, len - 6, len - 7 }),
         new ResourceMock("test_2.txt", new int[] { len - 2 },
               new int[] { len - 8 }, new int[0], new int[] { len - 2, len - 3,
                     len - 4, len - 5, len - 6, len - 7 }),
         new ResourceMock("test_3.txt", new int[] { len - 5 }, new int[0],
               new int[] { len - 8 }, new int[] { len - 5, len - 8 }),
         new ResourceMock("src/Test_renamed.txt", new int[] { len - 8 },
               new int[0], new int[0], new int[] { len - 8 }),
         new ResourceMock("main/test_3.txt", new int[] { len - 3 }, new int[0],
               new int[0], new int[] { len - 3, len - 4, len - 6, len - 7 }),
         new ResourceMock("Test_4.txt", new int[] { len - 4 }, new int[0],
               new int[0], new int[] { len - 4, len - 6, len - 7 }),
         new ResourceMock("src/java/test_src.txt", new int[] { len - 6 },
               new int[0], new int[0], new int[] { len - 6, len - 7 }),
         new ResourceMock("src/java/another.txt", new int[] { len - 7 },
               new int[0], new int[0], new int[] { len - 7 }), };

   /**
    * Directories of small repository and their history.
    * <p>
    */
   public static final ResourceMock[] DIRS = new ResourceMock[] {
         new ResourceMock("src", new int[] { len - 1 }, new int[] { len - 8 },
               new int[0], new int[] { len - 1, len - 2, len - 3, len - 4,
                     len - 5, len - 6, len - 7 }),
         new ResourceMock("main", new int[] { len - 3 }, new int[0],
               new int[0], new int[] { len - 3, len - 4, len - 6, len - 7 }),
         new ResourceMock("src/java", new int[] { len - 6 }, new int[0],
               new int[0], new int[] { len - 6, len - 7 }), };

   /**
    * Find from resource mocks if the given path is available at the given
    * commit.
    * <p>
    * 
    * @param path
   ...
   /**
    * Get all resources in this commit.
    * <p>
    * 
    * @param cid
    *           commit id
   ...
   /**
    * Get all resources under the given prefix in the given commit.
    * <p>
    * 
    * @param prefix
    * @param cid
    * @return
    */
   public static List<ResourceMock> resources(final String prefix,
         final String cid) {
      final List<ResourceMock> resources = new ArrayList<ResourceMock>();
   ...
   /**
    * Get from dir mocks the directory at the specified commit, if any.
    * <p>
    * 
    * @param path
    *           of directory
   ...
   /**
    * Check if this resource is child of given dir.
    * <p>
    * 
    * @param dir
    * @return
   ...
   /**
    * Indices of commits that creates this resource.
    * <p>
    */
   private final int[] created;

   /**
    * Indices of commits that deletes this resource.
    * <p>
    */
   private final int[] deleted;

   /**
    * Indices of commits that modify this resource.
    * <p>
    */
   private final int[] modified;

   /**
    * Indices of commits this resource is available.
    * <p>
    */
   private final int[] commits;

   public ResourceMock(final String path, final int[] created,
         final int[] deleted, final int[] modified, final int[] commits) {

...
public class VCSResourceImpTest extends VCSTest {
	 ...
	 * {@link VCSResourceImp#getAllCommits()}.<p>
	 */
	@Test
	...
	/**
	 * Test method for
	 * {@link VCSResourceImp#getCreationCommits()} and {@link VCSResourceImp#getDeletionCommits()}.<p>
	 */
	@Test
	public void testGetCreationDeletionCommits() throws Exception {
		...
		for (ResourceMock rm : ResourceMock.RESOURCES) {
			...
			// Collect all commits
			final Collection<VCSCommit> commitsCreate = resource.getCreationCommits();
			...
			// Now check get all commits
			// This method should work the same as walk all commits
			final Collection<VCSCommit> commitsDelete = resource.getDeletionCommits();

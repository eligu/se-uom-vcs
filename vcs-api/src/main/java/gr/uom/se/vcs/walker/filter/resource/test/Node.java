package gr.uom.se.vcs.walker.filter.resource.test;
...
public class Node {
   ...
   public boolean containsAllObject(Set objects) {
      for(Object o : objects) {
         if(!this.objects.contains(o)) {
            return false;
         }
   ...
   public void addChild(Node child) {
      ...
      if (child.equals(this)) {
         throw new IllegalArgumentException("can not add its self to children");
      }
      children.add(child);
   ...
   private static boolean containsPath(String[] segments, int current, Node node) {

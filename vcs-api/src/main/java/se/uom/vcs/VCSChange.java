...
public interface VCSChange<T extends VCSResource> {
	...
	/**
	 * A type of a change for a given resource, calculated as difference between two commits.
	 * <p>
	 * 
	 * @author Elvis Ligu
	 * @since 0.0.1
	...
	public static enum Type {
		 ...
		 * 
		 * Usually this is due to unsupported change that some specific
		 * VCSs support.
		 */
		NONE;
	...
	/**
	 * Get the new resource, the representation of the resource in the new revision.
	 * <p>
	...
	/**
	 * Get the old resource, the presentation of the resource in the old revision.
	 * <p>

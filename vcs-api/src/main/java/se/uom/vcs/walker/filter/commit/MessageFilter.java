 ...
 * Java.
 * <p>
 * HINTS: you can sub class this class to construct a filter that parses the message of
 * a commit and finds some known patterns. I.e. a known pattern at commit messages is
 * <code>FIX #123</code> which tells this commit fix the bug with id 123.
 * 
 * @author Elvis Ligu
 * @since 0.0.1
 * @version 0.0.1
